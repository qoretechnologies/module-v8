...
void copy_refs(ExceptionSink* xsink, QoreObject* source, QoreObject* target) {
    ...
    if (!v1) {
        ...
        tl = *rh;
        target->setMemberValue("promise_refs", QC_JAVASCRIPTPROMISE, *rh, xsink);
    } else {
...
void save_ref(ExceptionSink* xsink, ReferenceHolder<QoreListNode>& ref, QoreObject* obj) {
    ...
    if (v) {
        ...
        obj->setMemberValue("promise_refs", QC_JAVASCRIPTPROMISE, *ref, xsink);
...
# 115 "/module-v8/src/QC_JavaScriptPromise.qpp"
...
# 176 "/module-v8/src/QC_JavaScriptPromise.qpp"
    QoreV8ProgramHelper v8h(xsink, p->getProgram());
    if (*xsink) {
        return QoreValue();
    }
...
# 151 "/module-v8/src/QC_JavaScriptPromise.qpp"
    QoreV8ProgramHelper v8h(xsink, p->getProgram());
    if (*xsink) {
        return QoreValue();
    }
...
# 140 "/module-v8/src/QC_JavaScriptPromise.qpp"
    QoreV8ProgramHelper v8h(xsink, p->getProgram());
    if (*xsink) {
        return QoreValue();
    }
...
# 199 "/module-v8/src/QC_JavaScriptPromise.qpp"
...
static QoreValue JavaScriptPromise_methodGate_VsVV(QoreObject* self, QoreV8Promise* p, const QoreListNode* args, RuntimeConfig& runtime_cfg, ExceptionSink* xsink) {
    const QoreStringNode* m = HARD_QORE_VALUE_STRING(args, 0);
# 190 "/module-v8/src/QC_JavaScriptPromise.qpp"
...
# 90 "/module-v8/src/QC_JavaScriptPromise.qpp"
    QoreV8ProgramHelper v8h(xsink, p->getProgram());
    if (*xsink) {
        return QoreValue();
    }
...
# 163 "/module-v8/src/QC_JavaScriptPromise.qpp"
    QoreV8ProgramHelper v8h(xsink, p->getProgram());
    if (*xsink) {
        return QoreValue();
    }
...
# 60 "/module-v8/src/QC_JavaScriptPromise.qpp"
# 65 "/module-v8/src/QC_JavaScriptPromise.qpp"
# 68 "/module-v8/src/QC_JavaScriptPromise.qpp"
