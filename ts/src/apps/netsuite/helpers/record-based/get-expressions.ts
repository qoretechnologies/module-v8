/**
 * NetSuite Get Expressions
 *
 * Defines the supported filter expressions for NetSuite record-based operations.
 * Maps Qore expression operators to SuiteQL WHERE clause operators.
 *
...
/**
 * Get the supported expressions for NetSuite record-based search operations.
 * All operators map directly to SuiteQL syntax.
 */
export const getNetsuiteExpressions = (locale: Locales): TQoreSearchRecordsExpressions => {
