/**
 * Jira Search Expressions
 *
 * Defines the filter operators available for JQL-based searching.
 * These operators are mapped to JQL syntax for server-side filtering.
 *
...
/**
 * Get Jira search expressions with localized display names
 */
export const getJiraExpressions = (locale: Locales): TQoreSearchRecordsExpressions => {
