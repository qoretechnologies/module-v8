  ...
  event_info: {
    ...
    type: {
      ...
      fields: {
        ...
        firstresponsesent: { type: 'boolean' },
        ...
        followuptaskcreated: { type: 'boolean' },

        merged: { type: 'boolean' },
        customercontacted: { type: 'boolean' },
        checkemail: { type: 'boolean' },
        blockedprofile: { type: 'boolean' },
        routecase: { type: 'boolean' },
        isdecrementing: { type: 'boolean' },
        decremententitlementterm: { type: 'boolean' },
        ...
        msdyn_copilotengaged: { type: 'boolean' },
