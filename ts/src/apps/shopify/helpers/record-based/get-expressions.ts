/**
 * Shopify Search Expressions
 *
 * Defines the filter operators available for searching/filtering products.
 * These are mapped to Shopify's GraphQL query syntax.
 *
...
import { SHOPIFY_APP_NAME } from '../../constants';

/**
 * Get Shopify search expressions with localized display names
 */
export const getShopifyExpressions = (locale: Locales): TQoreSearchRecordsExpressions => {
