...
import { SurveyMonkeyBasicCollectorResponseType } from '../response-types';
...
const responseType = {
  type: 'list',
  element_type: SurveyMonkeyBasicCollectorResponseType,
} satisfies TQoreResponseType;

const listSurveyMonkeyCollectors = QoreAppCreator.createLocalizedAction<typeof options>({
...
export default listSurveyMonkeyCollectors;
