...
import { NewResponseWebhookEventResponseType } from '../response-types';
...
const SurveyMonkeyNewResponse = QoreAppCreator.createLocalizedTrigger<typeof options>({
  action: trigger,
  ...
  event_info: {
    desc: 'Response Completed Webhook Event Info',
    type: NewResponseWebhookEventResponseType,
  },
...
export default SurveyMonkeyNewResponse;
