...
const listOrganizationMembers = QoreAppCreator.createLocalizedAction<typeof options>({
  ...
  api_function: async (obj, _opts, context) => {
    ...
    try {
      ...
      throw new CalendlyError(`Failed to list organization members: ${error}`);
    }
  },
  response_type: {
    type: 'hash',
