...
const CalendlyInviteeCreated = QoreAppCreator.createLocalizedTrigger<
...
>({
  ...
  get_example_event_data: async (context) => {
    ...
    try {
      ...
      Debugger.log('Failed to fetch example event data for invitee created trigger:', error);
  ...
  event_info: {
    desc: 'Invitee created event data',
    type: {
      type: 'hash',
      fields: {
...
export default CalendlyInviteeCreated;
