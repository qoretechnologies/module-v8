...
import { ContactUpdatedEventResponseType } from '../response-types/webhook-events';

const trigger = 'updated_contact';

const ActiveCampaignUpdatedContact = QoreAppCreator.createLocalizedTrigger({
  action: trigger,
  ...
  event_info: {
    desc: 'Contact Update Event Info',
    type: ContactUpdatedEventResponseType,
  },
});

export default ActiveCampaignUpdatedContact;
