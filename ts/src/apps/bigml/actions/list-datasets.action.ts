  ...
  response_type: {
    ...
    element_type: {
      ...
      fields: {
        ...
        created: { type: 'string' },
        creator: { type: 'string' },
        dataset_origin_status: { type: 'bool' },
        ...
        origin_batch_dataset_status: { type: 'bool' },
        origin_batch_model: { type: 'string' },
        origin_batch_model_status: { type: 'bool' },
        origin_batch_resource: { type: 'string' },
        origin_batch_status: { type: 'bool' },
        output_fields: {
          type: {
            type: 'list',
            element_type: 'string',
        ...
        private: { type: 'bool' },
        project: { type: 'string' },
        refresh_field_types: { type: 'bool' },
        refresh_objective: { type: 'bool' },
        refresh_preferred: { type: 'bool' },
