...
import {
  BigMlTopicModelFilterableFieldAllowedValues,
  BigMlTopicModelSortableFieldAllowedValues,
} from '../helpers/get-topic-model-fields-allowed-values';
import { BigMlTopicModelResponseType } from '../response-types/topic-model.response-type';

const action = 'list_topic_models';
  ...
  filter: {
    ...
    type: {
      ...
      fields: {
        field: {
          type: 'string',
          allowed_values: BigMlTopicModelFilterableFieldAllowedValues,
          required: true,
        },
        value: {
          type: 'softstring',
  ...
  sort: {
    ...
    type: {
      ...
      fields: {
        field: {
          type: 'string',
          allowed_values: BigMlTopicModelSortableFieldAllowedValues,
          required: true,
        },
        order: {
          type: 'string',
...
const listTopicModels = QoreAppCreator.createLocalizedAction<typeof options>({
  app: BIG_ML_APP_NAME,
  action,
  ...
  response_type: {
    type: 'list',
    element_type: BigMlTopicModelResponseType,
  },
});

export default listTopicModels;
