...
import { QuickBooksEstimateFieldsAllowedValues } from '../../helpers/get-estimate-fields-allowed-values';
    ...
    type: {
      ...
      fields: {
        field: {
          ...
          allowed_values: QuickBooksEstimateFieldsAllowedValues,
        },
        operator: {
          type: 'string',
          required: false,
...
const listEstimates = QoreAppCreator.createLocalizedAction<typeof options>({
  ...
  api_function: async (obj, _opts, context) => {
    ...
    try {
      ...
      throw new QuickbooksError(`Failed to list estimates: ${getQuickbooksErrorMessage(error)}`);
    }
  },
  response_type: {
    type: 'hash',
