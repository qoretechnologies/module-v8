      ...
      presentation_details: {
        type: {
          ...
          fields: {
            ...
            show_author_header: { type: 'boolean' },
            show_contributor_header: { type: 'boolean' },
            show_cover_header: { type: 'boolean' },
            show_date_header: { type: 'boolean' },
            show_page_outline: { type: 'boolean' },
            show_sub_pages: { type: 'boolean' },
            sub_page_size: { type: 'string' },
            show_sub_title_header: { type: 'boolean' },
            show_title_icon_header: { type: 'boolean' },
            show_relationships: { type: 'boolean' },
            show_relationships_compact: { type: 'boolean' },
            show_sub_pages_author: { type: 'boolean' },
            show_sub_pages_thumbnail: { type: 'boolean' },
            show_sub_pages_compact: { type: 'boolean' },
