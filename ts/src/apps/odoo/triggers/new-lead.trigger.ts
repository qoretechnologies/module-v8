...
const OdooNewLeadTrigger = QoreAppCreator.createLocalizedTrigger({
  app: ODOO_APP_NAME,
  action: 'new_lead',
  ...
  event_info: {
    desc: 'Odoo New Lead Trigger Event Info',
    type: {
      type: 'hash',
      fields: {
        id: { type: 'integer' },
...
export default OdooNewLeadTrigger;
