...
const action = 'list_organization_issues';
...
const listOrganizationIssues = QoreAppCreator.createLocalizedAction<typeof options>({
  app: SENTRY_APP_NAME,
  action,
...
export default listOrganizationIssues;
