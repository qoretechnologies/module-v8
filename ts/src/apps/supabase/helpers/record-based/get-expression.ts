import { TQoreGetExpressionsFunction } from '@qoretechnologies/ts-toolkit';
import { SUPABASE_APP_NAME } from '../../constants';
import { mapExpressionsToApp } from '../../../../global/helpers';
import { Locales } from '../../../../i18n/i18n-types';

export const getSupabaseExpressionsFunction =
  (locale: Locales): TQoreGetExpressionsFunction =>
  (_context) => {
