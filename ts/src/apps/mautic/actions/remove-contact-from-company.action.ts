...
const action = 'remove_contact_from_company';
...
const removeContactFromCompany = QoreAppCreator.createLocalizedAction<typeof options>({
  app: MAUTIC_APP_NAME,
  action,
  ...
  api_function: async (obj, _opts, context) => {
    ...
    try {
      await mauticClient.post(
        `companies/${company}/contact/${contact}/remove`,
        {},
        {
