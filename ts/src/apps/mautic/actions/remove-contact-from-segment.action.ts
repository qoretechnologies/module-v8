...
const action = 'remove_contact_from_segment';
...
const removeContactFromSegment = QoreAppCreator.createLocalizedAction<typeof options>({
  app: MAUTIC_APP_NAME,
  action,
  ...
  api_function: async (obj, _opts, context) => {
    ...
    try {
      await mauticClient.post(
        `segments/${segment}/contact/${contact}/remove`,
        {},
        {
...
export default removeContactFromSegment;
