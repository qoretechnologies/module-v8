...
const newFormResponse = QoreAppCreator.createLocalizedTrigger({
  ...
  webhook_register: async (context, url) => {
    ...
    const data = await client.webhooks.create({
      tag: `qorus-webhook-${new Date().getTime()}`,
      url,
      enabled: true,
      uid: form_id,
    });
      ...
      answers: [
        ...
        },
        {
          ...
          choices: {
            ...
            refs: ['238d1802-9921-4687-a37b-5e50f56ece8e', 'd867c542-1e72-4619-908f-aaae38cabb61'],
          },
          field: {
            id: 'PNe8ZKBK8C2Q',
            type: 'picture_choice',
  ...
  event_info: {
    desc: 'Typeform Form Response Event Info',
    type: {
      type: 'hash',
      fields: {
...
export default newFormResponse;
