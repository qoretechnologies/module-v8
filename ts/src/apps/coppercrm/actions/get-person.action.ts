...
const GetPerson = QoreAppCreator.createLocalizedAction<typeof options>({
  ...
  api_function: async (obj, _opts, context) => {
    ...
    try {
      const response = await copperCrmApiClient<TGetPersonResponse>({
