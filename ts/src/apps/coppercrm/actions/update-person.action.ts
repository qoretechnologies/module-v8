...
const UpdatePerson = QoreAppCreator.createLocalizedAction<typeof options>({
  ...
  api_function: async (obj, _opts, context) => {
    ...
    const baseFields = omit(obj, ['custom_fields', 'person_id']);
    ...
    try {
      const response = await copperCrmApiClient<TUpdatePersonResponse>({
