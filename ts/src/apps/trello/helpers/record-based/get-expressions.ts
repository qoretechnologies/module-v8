/**
 * Trello Search Expressions
 *
 * Defines the filter operators available for searching/filtering cards.
 * Since Trello API lacks server-side filtering, these are applied client-side.
 *
...
/**
 * Get Trello search expressions with localized display names
 */
export const getTrelloExpressions = (locale: Locales): TQoreSearchRecordsExpressions => {
