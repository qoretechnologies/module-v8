...
const action = 'run_keyword_report';
...
const runKeywordReport = QoreAppCreator.createLocalizedAction<typeof options>({
  ...
  api_function: async (obj, _opts, context) => {
    ...
    const { campaign_id, ad_group_id, date_range, start_date, end_date, limit = 100 } = obj || {};
    ...
    try {
      ...
      throw new GoogleAdsError(`Failed to run keyword report: ${message}`);
    }
  },
  response_type: {
    type: 'list',
...
export default runKeywordReport;
