...
import { magentoProductEventInfo } from './event-info/product.event-info';
...
const triggerName = 'product-created-or-updated';
...
const magentoProductCreatedOrUpdatedTrigger = QoreAppCreator.createLocalizedTrigger({
  ...
  event_info: magentoProductEventInfo,
});
...
export default magentoProductCreatedOrUpdatedTrigger;
