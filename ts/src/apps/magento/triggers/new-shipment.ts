...
import { magentoShipmentEventInfo } from './event-info/shipment.event-info';

const triggerName = 'shipment-created';
...
const magentoShipmentCreatedTrigger = QoreAppCreator.createLocalizedTrigger({
  ...
  event_info: magentoShipmentEventInfo,
});
...
export default magentoShipmentCreatedTrigger;
