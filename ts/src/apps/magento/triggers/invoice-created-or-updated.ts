...
import { magentoInvoiceEventInfo } from './event-info/invoice.event-info';
...
const triggerName = 'invoice-created-or-updated';
...
const magentoInvoiceCreatedOrUpdatedTrigger = QoreAppCreator.createLocalizedTrigger({
  ...
  event_info: magentoInvoiceEventInfo,
});
...
export default magentoInvoiceCreatedOrUpdatedTrigger;
