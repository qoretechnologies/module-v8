/**
 * BambooHR Search Expressions
 *
 * Defines the filter operators available for searching/filtering employees.
 * Since BambooHR API lacks server-side filtering for custom reports,
...
import { BAMBOOHR_APP_NAME } from '../../constants';

/**
 * Get BambooHR search expressions with localized display names
 */
export const getBambooHRExpressions = (locale: Locales): TQoreSearchRecordsExpressions => {
