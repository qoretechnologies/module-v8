...
const ErrorInternal_1 = __importDefault(__nccwpck_require__(4794));
const LocalStorage_1 = __nccwpck_require__(8950);
const logger_1 = __importDefault(__nccwpck_require__(5370));
const QorusRequest_1 = __importDefault(__nccwpck_require__(9420));
const QorusValidator_1 = __importDefault(__nccwpck_require__(7599));
const utils_1 = __nccwpck_require__(5981);
const apiPaths_1 = __nccwpck_require__(1897);
/**
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.QorusDataProvider = void 0;
const ErrorQorusRequest_1 = __importDefault(__nccwpck_require__(8692));
const logger_1 = __importDefault(__nccwpck_require__(5370));
const QorusOptions_1 = __nccwpck_require__(5699);
const QorusRequest_1 = __importDefault(__nccwpck_require__(9420));
const apiPaths_1 = __nccwpck_require__(1897);
/**
...
class QorusDataProvider {
    ...
    async fetchWithContext(context) {
        // Making a put request
        const requestPath = getRequestPath([apiPaths_1.apiPathsInitial.dataProviders.browse]);
        const requestData = { context: context };
        const result = await QorusRequest_1.default.put({
            path: requestPath,
            data: requestData,
        });
    ...
    has(name) {
        var _a;
        const children = (_a = this.responseData) === null || _a === void 0 ? void 0 : _a.children.find((child) => child.name === name);
        if (typeof children === 'undefined' || !children.name)
            return false;
        else
            return true;
    }
    ...
    hasData() {
        var _a;
        if ((_a = this.responseData) === null || _a === void 0 ? void 0 : _a.matches_context)
            return true;
        else
            return false;
    }
    ...
    getChildren() {
        var _a;
        return (_a = this.responseData) === null || _a === void 0 ? void 0 : _a.children;
    }
    /**
    ...
    getChildrenNames() {
        ...
        let names = {};
        children === null || children === void 0 ? void 0 : children.forEach((child) => (names[child.name] = child.name));
        return names;
    }
    /**
     ...
     */
    getOptions(childrenName) {
        const children = this.getChildren();
        const filteredChildren = children === null || children === void 0 ? void 0 : children.filter((child) => child.name === childrenName);
        if (!filteredChildren || !filteredChildren[0]) {
            logger_1.default.error(`Children for the provider "${childrenName}" does not exist, please verify if the provider exist`);
            return;
        }
        return new QorusOptions_1.QorusOptions(filteredChildren[0]);
    }
    /**
     * A getter to get options by name for a children provider
    ...
    getAllOptions() {
        ...
        children === null || children === void 0 ? void 0 : children.forEach((child) => {
            const option = new QorusOptions_1.QorusOptions(child);
     ...
     */
    async get(select, providerOptions) {
        if (!select)
            return this;
...
exports.QorusDataProvider = QorusDataProvider;
/**
 ...
 */
const fetchProvider = async (obj, context, select, providerOptions) => {
    ...
    const requestData = { context: context, provider_options: providerOptions !== null && providerOptions !== void 0 ? providerOptions : {} };
    // Making a put request
    const result = await QorusRequest_1.default.put({
        path: requestPath,
        data: requestData,
    ...
    if (error === null || error === void 0 ? void 0 : error.status) {
        throw new ErrorQorusRequest_1.default(error !== null && error !== void 0 ? error : '');
    }
    const providerResponse = response === null || response === void 0 ? void 0 : response.data;
    const responseError = error;
    return new QorusDataProvider({ path: _path, responseData: providerResponse, context, responseError });
};
exports["default"] = new QorusDataProvider();
//# sourceMappingURL=QorusDataProvider.js.map
...
const ErrorInternal_1 = __importDefault(__nccwpck_require__(4794));
const ErrorQorusRequest_1 = __importDefault(__nccwpck_require__(8692));
const QorusAuthenticator_1 = __importDefault(__nccwpck_require__(6662));
const utils_1 = __nccwpck_require__(5981);
/**
    ...
    constructor() {
        ...
        this.makeRequest = async (type, props, endpoint) => {
            ...
            if (selectedEndpoint === null || selectedEndpoint === void 0 ? void 0 : selectedEndpoint.url) {
                if (selectedEndpoint === null || selectedEndpoint === void 0 ? void 0 : selectedEndpoint.authToken) {
                    Object.assign(headers, Object.assign(Object.assign({}, headers), { 'Qorus-Token': selectedEndpoint === null || selectedEndpoint === void 0 ? void 0 : selectedEndpoint.authToken }));
                }
...
const every_1 = __importDefault(__nccwpck_require__(6726));
const size_1 = __importDefault(__nccwpck_require__(2444));
const uniqWith_1 = __importDefault(__nccwpck_require__(6916));
const validation_1 = __nccwpck_require__(7238);
const cron_validator_1 = __importDefault(__nccwpck_require__(9175));
/*eslint-disable */
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.QorusValidator = exports.QorusRequest = exports.QorusDataProvider = exports.QorusAuthenticator = exports.QoreAppCreator = exports.Validator = exports.HttpRequest = exports.QorusOptions = exports.DataProvider = exports.Authenticator = void 0;
exports.Authenticator = __importStar(__nccwpck_require__(6662));
exports.DataProvider = __importStar(__nccwpck_require__(4228));
exports.QorusOptions = __importStar(__nccwpck_require__(5699));
exports.HttpRequest = __importStar(__nccwpck_require__(9420));
exports.Validator = __importStar(__nccwpck_require__(7599));
var QoreAppCreator_1 = __nccwpck_require__(5397);
Object.defineProperty(exports, "QoreAppCreator", ({ enumerable: true, get: function () { return QoreAppCreator_1.QoreAppCreator; } }));
var QorusAuthenticator_1 = __nccwpck_require__(6662);
...
var QorusDataProvider_1 = __nccwpck_require__(4228);
...
__exportStar(__nccwpck_require__(3376), exports);
__exportStar(__nccwpck_require__(119), exports);
__exportStar(__nccwpck_require__(3489), exports);
__exportStar(__nccwpck_require__(1954), exports);
__exportStar(__nccwpck_require__(750), exports);
__exportStar(__nccwpck_require__(5731), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const Error_1 = __importDefault(__nccwpck_require__(999));
const errorCodes_1 = __nccwpck_require__(3277);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.QoreAppCreator = void 0;
/* A class to create Qore Qog Apps */
class QoreAppCreator {
    ...
    */
    static createLocalizedTrigger(trigger) {
        return trigger;
    }
    ...
    /* Creates an action function to be used in an App
       ...
       requires the proper translations to be available in the localization file
    */
    static createLocalizedAction(action) {
        return action;
    }
    ...
    /* Creates an App with triggers and actions
       ...
       requires the proper translations to be available in the localization file
    */
    static createLocalizedApp(app) {
        return app;
    }
}
exports.QoreAppCreator = QoreAppCreator;
//# sourceMappingURL=QoreAppCreator.js.map
...
var getNative = __nccwpck_require__(8573),
...
var ListCache = __nccwpck_require__(8884),
    stackClear = __nccwpck_require__(1509),
    stackDelete = __nccwpck_require__(837),
    stackGet = __nccwpck_require__(6572),
    stackHas = __nccwpck_require__(6216),
    stackSet = __nccwpck_require__(1976);
...
var baseTimes = __nccwpck_require__(1299),
    ...
    isArray = __nccwpck_require__(7192),
...
var baseProperty = __nccwpck_require__(6136);
...
var baseForOwn = __nccwpck_require__(6484),
    createBaseEach = __nccwpck_require__(728);
...
var baseEach = __nccwpck_require__(1616);
...
var createBaseFor = __nccwpck_require__(3142);
...
var baseFor = __nccwpck_require__(6798),
    keys = __nccwpck_require__(6741);
...
var castPath = __nccwpck_require__(4955),
    toKey = __nccwpck_require__(5086);
...
var baseIsEqualDeep = __nccwpck_require__(9275),
    isObjectLike = __nccwpck_require__(1645);
...
var Stack = __nccwpck_require__(3262),
    equalArrays = __nccwpck_require__(5248),
    equalByTag = __nccwpck_require__(9895),
    equalObjects = __nccwpck_require__(2500),
    getTag = __nccwpck_require__(4512),
    isArray = __nccwpck_require__(7192),
    isBuffer = __nccwpck_require__(3739),
    isTypedArray = __nccwpck_require__(5000);
...
var Stack = __nccwpck_require__(3262),
    baseIsEqual = __nccwpck_require__(5777);
...
var isFunction = __nccwpck_require__(4329),
    ...
    toSource = __nccwpck_require__(4811);
...
var baseMatches = __nccwpck_require__(1244),
    baseMatchesProperty = __nccwpck_require__(6481),
    identity = __nccwpck_require__(6851),
    isArray = __nccwpck_require__(7192),
    property = __nccwpck_require__(1024);
...
var isPrototype = __nccwpck_require__(5944),
    nativeKeys = __nccwpck_require__(3787);
...
var baseIsMatch = __nccwpck_require__(7792),
    getMatchData = __nccwpck_require__(9081),
    matchesStrictComparable = __nccwpck_require__(8218);
...
var baseIsEqual = __nccwpck_require__(5777),
    get = __nccwpck_require__(181),
    hasIn = __nccwpck_require__(6306),
    isKey = __nccwpck_require__(897),
    isStrictComparable = __nccwpck_require__(2757),
    matchesStrictComparable = __nccwpck_require__(8218),
    toKey = __nccwpck_require__(5086);
...
var baseGet = __nccwpck_require__(877);
...
var Symbol = __nccwpck_require__(8584),
    ...
    isArray = __nccwpck_require__(7192),
    isSymbol = __nccwpck_require__(661);
...
var isArray = __nccwpck_require__(7192),
    isKey = __nccwpck_require__(897),
    stringToPath = __nccwpck_require__(2187),
    toString = __nccwpck_require__(7233);
...
var SetCache = __nccwpck_require__(3706),
    arraySome = __nccwpck_require__(935),
    cacheHas = __nccwpck_require__(4486);
...
var Symbol = __nccwpck_require__(8584),
    Uint8Array = __nccwpck_require__(9525),
    eq = __nccwpck_require__(5199),
    equalArrays = __nccwpck_require__(5248),
    mapToArray = __nccwpck_require__(3428),
    setToArray = __nccwpck_require__(1894);
...
var getAllKeys = __nccwpck_require__(8479);
...
var baseGetAllKeys = __nccwpck_require__(4586),
    getSymbols = __nccwpck_require__(5889),
    keys = __nccwpck_require__(6741);
...
var isKeyable = __nccwpck_require__(3245);
...
var isStrictComparable = __nccwpck_require__(2757),
    keys = __nccwpck_require__(6741);
...
var arrayFilter = __nccwpck_require__(954),
    stubArray = __nccwpck_require__(3400);
...
var DataView = __nccwpck_require__(7033),
    Map = __nccwpck_require__(8272),
    Promise = __nccwpck_require__(4455),
    Set = __nccwpck_require__(4986),
    WeakMap = __nccwpck_require__(7364),
    baseGetTag = __nccwpck_require__(9117),
    toSource = __nccwpck_require__(4811);
...
var memoize = __nccwpck_require__(4769);
...
var ListCache = __nccwpck_require__(8884),
    Map = __nccwpck_require__(8272),
    MapCache = __nccwpck_require__(9660);
...
var asciiSize = __nccwpck_require__(112),
    hasUnicode = __nccwpck_require__(8715),
    unicodeSize = __nccwpck_require__(9716);
...
var memoizeCapped = __nccwpck_require__(1471);
...
var isSymbol = __nccwpck_require__(661);
...
var arrayEvery = __nccwpck_require__(3776),
    baseEvery = __nccwpck_require__(2990),
    baseIteratee = __nccwpck_require__(7988),
    isArray = __nccwpck_require__(7192),
...
var baseHasIn = __nccwpck_require__(6186),
    hasPath = __nccwpck_require__(8253);
...
var arrayLikeKeys = __nccwpck_require__(2000),
    baseKeys = __nccwpck_require__(1517),
    isArrayLike = __nccwpck_require__(5119);
...
var baseProperty = __nccwpck_require__(6136),
    basePropertyDeep = __nccwpck_require__(2310),
    isKey = __nccwpck_require__(897),
    toKey = __nccwpck_require__(5086);
...
var baseKeys = __nccwpck_require__(1517),
    getTag = __nccwpck_require__(4512),
    isArrayLike = __nccwpck_require__(5119),
    isString = __nccwpck_require__(4048),
    stringSize = __nccwpck_require__(6012);
...
var baseToString = __nccwpck_require__(7625);
...
var baseUniq = __nccwpck_require__(2772);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ArchiveRecord = void 0;
const ts_toolkit_1 = __nccwpck_require__(9635);
const constants_1 = __nccwpck_require__(7242);
const constants_2 = __nccwpck_require__(858);
const get_board_id_allowed_values_1 = __nccwpck_require__(7328);
const get_record_id_allowed_values_1 = __nccwpck_require__(2683);
const ArchiveRecordOptions = {
    board_id: {
        ...
        get_allowed_values: get_board_id_allowed_values_1.getMondayBoardIdAllowedValues,
    },
    record_id: {
        ...
        required: true,
        allowed_values_creatable: true,
        get_allowed_values: get_record_id_allowed_values_1.getMondayRecordIdAllowedValues,
    },
};
...
exports.ArchiveRecord = ts_toolkit_1.QoreAppCreator.createAction({
    action: 'archive-record',
    app: constants_1.MONDAY_APP_NAME,
    action_code: ts_toolkit_1.EQoreAppActionCode.ACTION,
    display_name: 'Archive Record',
    short_desc: 'Move a record to the archive.',
    desc: 'This action allows you to archive a specific record,' +
  ...
  `;
        return (0, constants_2.callMondayAPI)({
            query,
            variables: { recordId },
            token,
        });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ClearColumnValue = void 0;
const ts_toolkit_1 = __nccwpck_require__(9635);
const constants_1 = __nccwpck_require__(7242);
const get_board_id_allowed_values_1 = __nccwpck_require__(7328);
const get_record_id_allowed_values_1 = __nccwpck_require__(2683);
const get_column_id_allowed_values_1 = __nccwpck_require__(6224);
const constants_2 = __nccwpck_require__(858);
const options = {
    board_id: {
        display_name: 'Board ID',
    ...
    column_id: {
        ...
        required: true,
        allowed_values_creatable: true,
        get_allowed_values: get_column_id_allowed_values_1.getMondayColumnIdAllowedValues,
    },
};
const response_type = {
    type: 'hash',
...
exports.ClearColumnValue = ts_toolkit_1.QoreAppCreator.createAction({
    ...
    api_function: (data, _opts, context) => {
        ...
        if (!recordId || !columnId || !token || !boardId) {
            throw new Error('All record_id, column_id, board_id, token, are required to clear a Monday app column value.');
        }
        const query = `
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.callMondayAPI = void 0;
const ts_toolkit_1 = __nccwpck_require__(9635);
const constants_1 = __nccwpck_require__(7242);
const callMondayAPI = async (options) => {
    const { query, token } = options;
    const response = await ts_toolkit_1.QorusRequest.post({
        path: '/v2',
        headers: {
        ...
        endpointId: constants_1.MONDAY_APP_NAME,
    });
...
exports.callMondayAPI = callMondayAPI;
...
const constants_2 = __nccwpck_require__(858);
const get_board_id_allowed_values_1 = __nccwpck_require__(7328);
const get_group_id_allowed_values_1 = __nccwpck_require__(275);
const get_board_dependent_options_1 = __nccwpck_require__(7329);
const options = {
    board_id: {
        display_name: 'Board ID',
        ...
        allowed_values_creatable: true,
        get_allowed_values: get_board_id_allowed_values_1.getMondayBoardIdAllowedValues,
        get_dependent_options: get_board_dependent_options_1.getMondayBoardDependentOptions,
    },
    group_id: {
        ...
        required: true,
        allowed_values_creatable: true,
        get_allowed_values: get_group_id_allowed_values_1.getMondayGroupIdAllowedValues,
    },
    item_name: {
...
exports.CreateRecord = ts_toolkit_1.QoreAppCreator.createAction({
    action: 'create-record',
    app: constants_1.MONDAY_APP_NAME,
    action_code: ts_toolkit_1.EQoreAppActionCode.ACTION,
    display_name: 'Create Record',
    short_desc: 'Add a new record to a board.',
    desc: 'This action enables you to create a new record (item) in a specified board, ' +
    ...
    api_function: (data, _opts, context) => {
        ...
        if (!boardId || !groupId || !itemName || !token) {
            throw new Error('board_id, group_id, item_name, token are required to create a Monday app record.');
        }
        const query = `
...
exports.CustomAction = ts_toolkit_1.QoreAppCreator.createAction({
    action: 'custom-action',
    app: constants_1.MONDAY_APP_NAME,
    action_code: ts_toolkit_1.EQoreAppActionCode.ACTION,
    display_name: 'Custom Action',
    short_desc: 'Perform a user-defined operation.',
    desc: 'This action allows you to execute a custom operation defined by your integration or automation setup, ' +
  ...
  `;
        return await (0, constants_2.callMondayAPI)({
            token,
            query,
...
exports.DeleteRecord = ts_toolkit_1.QoreAppCreator.createAction({
  ...
  `;
        return (0, constants_2.callMondayAPI)({ query, variables: { recordId }, token });
    },
    options,
    response_type,
});
...
exports.GetRecord = ts_toolkit_1.QoreAppCreator.createAction({
    action: 'get-record',
    app: constants_1.MONDAY_APP_NAME,
    action_code: ts_toolkit_1.EQoreAppActionCode.ACTION,
  ...
  `;
        const result = await (0, constants_2.callMondayAPI)({
            query,
            token,
            variables: { recordId },
        });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMondayBoardDependentOptions = void 0;
const constants_1 = __nccwpck_require__(858);
const mapMondayColumnToQoreOption = (column) => {
...
const getMondayBoardDependentOptions = async (context) => {
    const token = context?.conn_opts?.token;
  ...
  `;
    const response = await (0, constants_1.callMondayAPI)({
        query,
        token,
        variables: {
            boardId: board_id,
...
exports.getMondayBoardDependentOptions = getMondayBoardDependentOptions;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMondayBoardIdAllowedValues = void 0;
const constants_1 = __nccwpck_require__(858);
const mapMondayBoard = (board) => ({
    value: board.id,
    display_name: board.name,
    short_desc: `ID: ${board.id}\n\nName: ${board.name}`,
});
const getMondayBoardIdAllowedValues = async (context) => {
    const token = context?.conn_opts?.token;
    if (!token) {
...
exports.getMondayBoardIdAllowedValues = getMondayBoardIdAllowedValues;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMondaySingleColumnAllowedValues = void 0;
const constants_1 = __nccwpck_require__(858);
const getMondaySingleColumnAllowedValues = async (context) => {
    const token = context?.conn_opts?.token;
    const board_id = context?.opts?.board_id;
  ...
  `;
    ...
    return Object.keys(settings.labels).map((key) => ({
        value: key,
        display_name: settings.labels[key],
        short_desc: `Value: ${key}\n\nLabel: ${settings.labels[key]}`,
    }));
};
exports.getMondaySingleColumnAllowedValues = getMondaySingleColumnAllowedValues;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMondayColumnIdAllowedValues = void 0;
const constants_1 = __nccwpck_require__(858);
const mapMondayColumn = (column) => ({
    value: column.id,
    display_name: column.title,
    short_desc: `Column ID: ${column.id}\nTitle: ${column.title}`,
});
const getMondayColumnIdAllowedValues = async (context) => {
    const token = context?.conn_opts?.token;
    const board_id = context?.opts?.board_id;
    if (!token) {
...
exports.getMondayColumnIdAllowedValues = getMondayColumnIdAllowedValues;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMondayGroupIdAllowedValues = void 0;
const constants_1 = __nccwpck_require__(858);
const mapMondayGroup = (group) => ({
    value: group.id,
    display_name: group.title,
    short_desc: `Group ID: ${group.id}\n\nTitle: ${group.title}`,
});
const getMondayGroupIdAllowedValues = async (context) => {
    const token = context?.conn_opts?.token;
    const board_id = context?.opts?.board_id;
    if (!token) {
...
exports.getMondayGroupIdAllowedValues = getMondayGroupIdAllowedValues;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMondayRecordIdAllowedValues = void 0;
const constants_1 = __nccwpck_require__(858);
const mapMondayRecord = (record) => ({
    value: record.id,
    display_name: record.name,
    short_desc: `ID: ${record.id}\n\nName: ${record.name}\n\n` +
        `Created At: ${record.created_at}\n\n` +
        `Updated At: ${record.updated_at}`,
});
const getMondayRecordIdAllowedValues = async (context) => {
    const token = context?.conn_opts?.token;
    const board_id = context?.opts?.board_id;
    if (!token) {
...
exports.getMondayRecordIdAllowedValues = getMondayRecordIdAllowedValues;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.UpdateRecord = exports.SearchRecords = exports.MoveRecord = exports.GetRecord = exports.DeleteRecord = exports.CustomAction = exports.CreateRecord = exports.ClearColumnValue = exports.ArchiveRecord = void 0;
var archive_record_1 = __nccwpck_require__(2847);
Object.defineProperty(exports, "ArchiveRecord", ({ enumerable: true, get: function () { return archive_record_1.ArchiveRecord; } }));
var clear_column_value_1 = __nccwpck_require__(6893);
Object.defineProperty(exports, "ClearColumnValue", ({ enumerable: true, get: function () { return clear_column_value_1.ClearColumnValue; } }));
var create_record_1 = __nccwpck_require__(3665);
Object.defineProperty(exports, "CreateRecord", ({ enumerable: true, get: function () { return create_record_1.CreateRecord; } }));
var custom_action_1 = __nccwpck_require__(9287);
Object.defineProperty(exports, "CustomAction", ({ enumerable: true, get: function () { return custom_action_1.CustomAction; } }));
var delete_record_1 = __nccwpck_require__(9484);
Object.defineProperty(exports, "DeleteRecord", ({ enumerable: true, get: function () { return delete_record_1.DeleteRecord; } }));
var get_record_1 = __nccwpck_require__(9193);
Object.defineProperty(exports, "GetRecord", ({ enumerable: true, get: function () { return get_record_1.GetRecord; } }));
var move_record_1 = __nccwpck_require__(826);
Object.defineProperty(exports, "MoveRecord", ({ enumerable: true, get: function () { return move_record_1.MoveRecord; } }));
var search_records_1 = __nccwpck_require__(4660);
Object.defineProperty(exports, "SearchRecords", ({ enumerable: true, get: function () { return search_records_1.SearchRecords; } }));
var update_record_1 = __nccwpck_require__(2382);
Object.defineProperty(exports, "UpdateRecord", ({ enumerable: true, get: function () { return update_record_1.UpdateRecord; } }));
...
exports.MoveRecord = ts_toolkit_1.QoreAppCreator.createAction({
    action: 'move-record',
    app: constants_1.MONDAY_APP_NAME,
    action_code: ts_toolkit_1.EQoreAppActionCode.ACTION,
    display_name: 'Move Record',
    short_desc: 'Transfer a record to another group or board.',
    desc: 'Use this action to move a record from its current group or board ' +
    ...
    api_function: (data, _opts, context) => {
        ...
        if (!recordId || !token || !groupId) {
            throw new Error('record_id, destination_group_id, token are required to move a Monday app record.');
        }
        const query = `
...
const get_board_id_allowed_values_1 = __nccwpck_require__(7328);
const get_column_id_allowed_values_1 = __nccwpck_require__(6224);
const get_column_allowed_values_1 = __nccwpck_require__(6072);
const options = {
    board_id: {
        display_name: 'Board ID',
    ...
    query_text: {
        ...
        type: 'string',
        allowed_values_creatable: true,
        get_allowed_values: get_column_allowed_values_1.getMondaySingleColumnAllowedValues,
        required: true,
    },
    columnId: {
        display_name: 'Column ID',
...
exports.SearchRecords = ts_toolkit_1.QoreAppCreator.createAction({
    action: 'search-records',
    app: constants_1.MONDAY_APP_NAME,
    action_code: ts_toolkit_1.EQoreAppActionCode.ACTION,
    display_name: 'Search Records',
    short_desc: 'Find records matching specific criteria.',
    desc: 'This action allows you to search for records that meet defined criteria, ' +
    ...
    api_function: async (data, _opts, context) => {
        ...
        if (!boardId || !token || !queryText) {
            throw new Error('board_id, search_query token are required to search for Monday app records.');
        }
        const query = `
  ...
  `;
        const results = await (0, constants_2.callMondayAPI)({
            query,
            variables: {
                boardId,
                queryText,
...
exports.UpdateRecord = ts_toolkit_1.QoreAppCreator.createAction({
    action: 'update-record',
    app: constants_1.MONDAY_APP_NAME,
    action_code: ts_toolkit_1.EQoreAppActionCode.ACTION,
    display_name: 'Update Record',
    short_desc: `Modify the values of a record's columns.`,
    desc: 'Use this action to update one or more column values of a specific record, ' +
    ...
    api_function: (data, _opts, context) => {
        ...
        if (!recordId || !token || !columnValues || !boardId) {
            throw new Error('board_id, column_values, record_id, token are required to update a Monday app record.');
        }
        const query = `
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.MONDAY_APP_NAME = void 0;
exports.MONDAY_APP_NAME = 'Monday';
...
const ts_toolkit_1 = __nccwpck_require__(9635);
const constants_1 = __nccwpck_require__(7242);
const MondayActions = __importStar(__nccwpck_require__(79));
const MondayTriggers = __importStar(__nccwpck_require__(4497));
const actions = Object.values(MondayActions);
const triggers = Object.values(MondayTriggers);
const MondayApp = ts_toolkit_1.QoreAppCreator.createApp({
    name: constants_1.MONDAY_APP_NAME,
    display_name: 'Monday',
    desc: 'Monday.com is a cloud-based Work Operating System (Work OS).',
    short_desc: 'Enables teams to build custom workflows and applications to manage' +
        'projects, processes, and everyday tasks efficiently.',
    actions: [...actions, ...triggers],
    logo: `PHN2ZyBoZWlnaHQ9IjE1NDkiIHZpZXdCb3g9Ii0xLjY2IC00LjEwMjA0OTMyID` +
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMondayBoardItems = exports.deregisterMondayWebhook = exports.registerMondayWebhook = void 0;
const constants_1 = __nccwpck_require__(858);
const registerMondayWebhook = async (options) => {
  ...
  `;
    try {
        const result = await (0, constants_1.callMondayAPI)({
            token,
            query,
            variables: variables,
        });
...
exports.registerMondayWebhook = registerMondayWebhook;
const deregisterMondayWebhook = async (context, _url, regInfo) => {
    const token = context.conn_opts?.token;
  ...
  `;
    try {
        await (0, constants_1.callMondayAPI)({
            token,
            query,
            variables: { webhookId },
        });
...
exports.deregisterMondayWebhook = deregisterMondayWebhook;
const getMondayBoardItems = async (options) => {
...
exports.getMondayBoardItems = getMondayBoardItems;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.updatedRecord = exports.newRecord = exports.recordColumnValueUpdated = exports.newRecordMovedToGroup = void 0;
var new_record_moved_to_group_trigger_1 = __nccwpck_require__(1905);
Object.defineProperty(exports, "newRecordMovedToGroup", ({ enumerable: true, get: function () { return __importDefault(new_record_moved_to_group_trigger_1).default; } }));
var record_column_value_updated_trigger_1 = __nccwpck_require__(5599);
Object.defineProperty(exports, "recordColumnValueUpdated", ({ enumerable: true, get: function () { return __importDefault(record_column_value_updated_trigger_1).default; } }));
var new_record_trigger_1 = __nccwpck_require__(8911);
Object.defineProperty(exports, "newRecord", ({ enumerable: true, get: function () { return __importDefault(new_record_trigger_1).default; } }));
var updated_record_trigger_1 = __nccwpck_require__(1556);
Object.defineProperty(exports, "updatedRecord", ({ enumerable: true, get: function () { return __importDefault(updated_record_trigger_1).default; } }));
...
const get_group_id_allowed_values_1 = __nccwpck_require__(275);
const constants_1 = __nccwpck_require__(7242);
const constants_2 = __nccwpck_require__(2768);
const options = {
    board_id: {
        display_name: 'Board ID',
...
const mondayNewRecordMovedToGroupTrigger = ts_toolkit_1.QoreAppCreator.createTrigger({
    app: constants_1.MONDAY_APP_NAME,
    action: 'new_record_moved_to_group',
    action_code: ts_toolkit_1.EQoreAppActionCode.EVENT,
    ...
    webhook_register: (context, url) => {
        ...
        if (!token || !boardId || !groupId) {
            throw new Error('The token, board_id, group_id are required to start the Monday new_record_moved_to_group trigger');
        }
        const variables = {
            boardId,
            url,
        ...
        return (0, constants_2.registerMondayWebhook)({
...
exports["default"] = mondayNewRecordMovedToGroupTrigger;
...
const get_board_id_allowed_values_1 = __nccwpck_require__(7328);
const constants_1 = __nccwpck_require__(7242);
const triggers_1 = __nccwpck_require__(8932);
const constants_2 = __nccwpck_require__(2768);
const options = {
    board_id: {
        display_name: 'Board ID',
...
const mondayNewRecordTrigger = ts_toolkit_1.QoreAppCreator.createTrigger({
    app: constants_1.MONDAY_APP_NAME,
    action: 'new_record',
    action_code: ts_toolkit_1.EQoreAppActionCode.EVENT,
    ...
    event_function: async (context, update, should_stop) => {
        ...
        const token = context.conn_opts?.token;
        if (!token || !boardId) {
            throw new Error('The token, board_id are required to start the Monday new_record trigger');
        }
        const getRecords = () => {
            return (0, constants_2.getMondayBoardItems)({
                token,
                boardId,
                limit: triggers_1.DEFAULT_TRIGGER_POLL_ITEM_LIMIT,
                orderBy: 'created_at',
                orderDirection: 'desc',
            });
        };
        await (0, triggers_1.pollCreatedItemsForTrigger)({
...
exports["default"] = mondayNewRecordTrigger;
...
const mondayRecordColumnValueUpdatedTrigger = ts_toolkit_1.QoreAppCreator.createTrigger({
    app: constants_1.MONDAY_APP_NAME,
    ...
    webhook_register: (context, url) => {
        ...
        if (!token || !boardId || !columnId) {
            throw new Error('The token, board_id, column_id are required to start the Monday record_column_value_updated trigger');
        }
        const variables = {
            boardId,
            url,
...
exports["default"] = mondayRecordColumnValueUpdatedTrigger;
...
const mondayUpdatedRecordTrigger = ts_toolkit_1.QoreAppCreator.createTrigger({
    app: constants_1.MONDAY_APP_NAME,
    ...
    event_function: async (context, update, should_stop) => {
        ...
        const token = context.conn_opts?.token;
        if (!token || !boardId) {
            throw new Error('The token, board_id are required to start the Monday updated_record trigger');
        }
        const getRecords = () => {
            return (0, constants_2.getMondayBoardItems)({
                token,
        ...
        await (0, triggers_1.pollUpdatedItemsForTrigger)({
...
exports["default"] = mondayUpdatedRecordTrigger;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.pollUpdatedItemsForTrigger = exports.pollCreatedItemsForTrigger = exports.delayOrCancel = exports.DEFAULT_TRIGGER_SAVED_ITEMS_LIMIT_MAX = exports.DEFAULT_TRIGGER_POLL_ITEM_LIMIT = exports.DEFAULT_TRIGGER_POLLING_INTERVAL = void 0;
exports.DEFAULT_TRIGGER_POLLING_INTERVAL = 30_000;
exports.DEFAULT_TRIGGER_POLL_ITEM_LIMIT = 10;
exports.DEFAULT_TRIGGER_SAVED_ITEMS_LIMIT_MAX = 100;
const delayOrCancel = (ms, shouldStop) => Promise.race([
    new Promise((resolve) => {
...
exports.delayOrCancel = delayOrCancel;
const pollCreatedItemsForTrigger = async (opts) => {
    ...
    try {
        ...
        while (!should_stop()) {
            ...
            if (processedItems.size > exports.DEFAULT_TRIGGER_SAVED_ITEMS_LIMIT_MAX) {
                processedItems = new Set(Array.from(processedItems).slice(-exports.DEFAULT_TRIGGER_SAVED_ITEMS_LIMIT_MAX));
            }
            await (0, exports.delayOrCancel)(exports.DEFAULT_TRIGGER_POLLING_INTERVAL, should_stop);
        }
    }
    catch (error) {
        console.error(`Error during polling data for trigger: ${trigger_name}`, error);
    }
};
exports.pollCreatedItemsForTrigger = pollCreatedItemsForTrigger;
const pollUpdatedItemsForTrigger = async (opts) => {
    ...
    try {
        ...
        while (!should_stop()) {
            ...
            if (lastSeenEdits.size > exports.DEFAULT_TRIGGER_SAVED_ITEMS_LIMIT_MAX) {
                const sortedEntries = Array.from(lastSeenEdits.entries()).sort((a, b) => a[1] - b[1]);
                const toKeep = sortedEntries.slice(-exports.DEFAULT_TRIGGER_SAVED_ITEMS_LIMIT_MAX);
                lastSeenEdits.clear();
...
exports.pollUpdatedItemsForTrigger = pollUpdatedItemsForTrigger;
