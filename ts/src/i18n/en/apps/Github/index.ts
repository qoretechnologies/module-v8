const GithubAppEn = {
  ...
  actions: {
    'repos-list-for-org': { group: 'Repositories' },
    'repos-create-in-org': { group: 'Repositories' },
    'repos-delete': { group: 'Repositories' },
    'repos-get': { group: 'Repositories' },
    'repos-update': { group: 'Repositories' },
    'repos-list-for-authenticated-user': { group: 'Repositories' },
    'repos-create-for-authenticated-user': { group: 'Repositories' },
    'repos-list-contributors': { group: 'Repositories' },
    'repos-get-content': { group: 'Content & Files' },
    'repos-delete-file': { group: 'Content & Files' },
    'repos-create-or-update-file-contents': { group: 'Content & Files' },
    'repos-list-branches': { group: 'Branches' },
    'repos-get-branch': { group: 'Branches' },
    new_repository_branch: { group: 'Event Triggers' },
    'repos-list-collaborators': { group: 'Collaborators' },
    'repos-list-commits': { group: 'Commits' },
    new_commit: { group: 'Event Triggers' },
    new_commit_comment: { group: 'Event Triggers' },
    'issues-list': { group: 'Issues' },
    'issues-list-for-repo': { group: 'Issues' },
    'issues-create': { group: 'Issues' },
    'issues-get': { group: 'Issues' },
    'issues-update': { group: 'Issues' },
    'issues-remove-assignees': { group: 'Issues' },
    'issues-add-assignees': { group: 'Issues' },
    new_repository_issue: { group: 'Event Triggers' },
    'pulls-list': { group: 'Pull Requests' },
    'pulls-create': { group: 'Pull Requests' },
    'pulls-get': { group: 'Pull Requests' },
    'pulls-update': { group: 'Pull Requests' },
    'pulls-remove-requested-reviewers': { group: 'Pull Requests' },
    'pulls-list-requested-reviewers': { group: 'Pull Requests' },
    'pulls-request-reviewers': { group: 'Pull Requests' },
    new_pull_request: { group: 'Event Triggers' },
    new_review_request: { group: 'Event Triggers' },
    'actions-get-repo-public-key': { group: 'Actions & Secrets' },
    'actions-delete-repo-secret': { group: 'Actions & Secrets' },
    'actions-get-repo-secret': { group: 'Actions & Secrets' },
    'actions-create-or-update-repo-secret': { group: 'Actions & Secrets' },
    'actions-list-repo-workflows': { group: 'Actions & Secrets' },
    'git-create-ref': { group: 'Git' },
    'repos-list-releases': { group: 'Releases' },
    'repos-create-release': { group: 'Releases' },
    new_release: { group: 'Event Triggers' },
    'orgs-list-members': { group: 'Organizations' },
    'search-issues-and-pull-requests': { group: 'Search' },
    'search-repos': { group: 'Search' },
  },
};
