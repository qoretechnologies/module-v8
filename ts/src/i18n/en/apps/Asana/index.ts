...
const AsanaAppEn = {
  ...
  actions: {
    getEvents: { group: 'Time & Events' },
    getGoals: { group: 'Goals' },
    createGoal: { group: 'Goals' },
    deleteGoal: { group: 'Goals' },
    getGoal: { group: 'Goals' },
    updateGoal: { group: 'Goals' },

    getProjects: { group: 'Projects' },
    createProject: { group: 'Projects' },
    deleteProject: { group: 'Projects' },
    getProject: { group: 'Projects' },
    updateProject: { group: 'Projects' },
    getSectionsForProject: { group: 'Projects' },
    createSectionForProject: { group: 'Projects' },
    getTasksForProject: { group: 'Projects' },
    project_task_added: { group: 'Event Triggers' },
    project_added: { group: 'Event Triggers' },

    getSection: { group: 'Sections' },
    updateSection: { group: 'Sections' },
    deleteSection: { group: 'Sections' },
    getTasksForSection: { group: 'Sections' },
    task_moved_to_section: { group: 'Event Triggers' },

    getTasks: { group: 'Tasks' },
    createTask: { group: 'Tasks' },
    deleteTask: { group: 'Tasks' },
    getTask: { group: 'Tasks' },
    updateTask: { group: 'Tasks' },
    getDependenciesForTask: { group: 'Tasks' },
    getDependentsForTask: { group: 'Tasks' },
    getStoriesForTask: { group: 'Tasks' },
    createStoryForTask: { group: 'Tasks' },
    getSubtasksForTask: { group: 'Tasks' },
    createSubtaskForTask: { group: 'Tasks' },
    task_completed: { group: 'Event Triggers' },
    subtask_completed: { group: 'Event Triggers' },
    task_comment_added: { group: 'Event Triggers' },
    task_story_added: { group: 'Event Triggers' },
    task_subtask_added: { group: 'Event Triggers' },

    getTags: { group: 'Tags' },
    createTag: { group: 'Tags' },
    deleteTag: { group: 'Tags' },
    getTag: { group: 'Tags' },
    updateTag: { group: 'Tags' },
    getTasksForTag: { group: 'Tags' },
    task_tag_added: { group: 'Event Triggers' },
    tag_created: { group: 'Event Triggers' },

    getProjectsForTeam: { group: 'Teams & Users' },
    createProjectForTeam: { group: 'Teams & Users' },
    getUsers: { group: 'Teams & Users' },
    getUser: { group: 'Teams & Users' },
    user_added: { group: 'Event Triggers' },
    team_added: { group: 'Event Triggers' },

    getWorkspaces: { group: 'Workspaces' },
    getWorkspace: { group: 'Workspaces' },
    updateWorkspace: { group: 'Workspaces' },

    getTimePeriods: { group: 'Other' },
  },
};
