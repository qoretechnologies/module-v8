...
import { OAuth2GrantType } from '../../../shared/app-connection/dto/upsert-app-connection-request';
...
export type OAuth2Property<T extends OAuth2Props> = BasePieceAuthSchema<OAuth2PropertyValue> &
  OAuth2ExtraProps &
  TPropertyValue<OAuth2PropertyValue<T>, PropertyType.OAUTH2, ValidationInputType.ANY, true>;
